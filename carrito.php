...
class Cart {
    ...
    public function insert($item = array()){
        if(!is_array($item) OR count($item) == 0){
            ...
            if(!isset($item['id_producto'], $item['nombre'], $item['precio'], $item['cantidad'],['img_producto'])){
                return FALSE;
            }else{
                /*
                 * Insert Item
    ...
    public function update($item = array()){
        if (!is_array($item) OR count($item) === 0){
            ...
            if (!isset($item['rowid'], $this->cart_contents[$item['rowid']])){
                ...
                foreach(array_diff($keys, array('producto_id', 'nombre')) as $key){
