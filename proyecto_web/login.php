	...
	<div class="contenedor">
		...
		<header>
            ...
            <h3>LOGIN</h3>
              ...
              <br><br>
			        <input class= "correo" type="email" name="email_u" placeholder="correo@example.com" required>
              
              <label class="contra" for="password">Contraseña: </label>
              <br><br>
              <input class="contra" type="password" name="password_u" minlength="8'" required>
